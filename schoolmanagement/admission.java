...
public class admission extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jemail)
                    .addComponent(last)
                    .addComponent(regno, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .addComponent(pass)
                    .addComponent(first)
                    .addComponent(course))
                .addGap(39, 39, 39))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql ="insert into students values('"+RegNo+"','"+fname+"','"+lname+"','"+email+"','"+password+"')";
            stm.executeUpdate(sql);
            JOptionPane.showMessageDialog(this,"Admission Successful");
           
         admission dr = new admission();
        dr.setVisible(true);
        setVisible(false);         
        }
         catch(Exception e){
